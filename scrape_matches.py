...
TEAMS = {
    # 东道主 + 北美
    "Canada":                  {"code": "CAN", "slug": "canada",             "name_ja": "カナダ",       "flag": "🇨🇦"},
    "Mexico":                  {"code": "MEX", "slug": "mexico",             "name_ja": "メキシコ",     "flag": "🇲🇽"},
    "United States":           {"code": "USA", "slug": "united-states",      "name_ja": "アメリカ",     "flag": "🇺🇸"},
    "Panama":                  {"code": "PAN", "slug": "panama",             "name_ja": "パナマ",       "flag": "🇵🇦"},
    "Curaçao":                 {"code": "CUW", "slug": "curacao",            "name_ja": "キュラソー",   "flag": "🇨🇼"},
    "Haiti":                   {"code": "HAI", "slug": "haiti",              "name_ja": "ハイチ",       "flag": "🇭🇹"},
    # 南美
    "Argentina":               {"code": "ARG", "slug": "argentina",          "name_ja": "アルゼンチン", "flag": "🇦🇷"},
    "Brazil":                  {"code": "BRA", "slug": "brazil",             "name_ja": "ブラジル",     "flag": "🇧🇷"},
    "Colombia":                {"code": "COL", "slug": "colombia",           "name_ja": "コロンビア",   "flag": "🇨🇴"},
    "Ecuador":                 {"code": "ECU", "slug": "ecuador",            "name_ja": "エクアドル",   "flag": "🇪🇨"},
    "Paraguay":                {"code": "PAR", "slug": "paraguay",           "name_ja": "パラグアイ",   "flag": "🇵🇾"},
    "Uruguay":                 {"code": "URU", "slug": "uruguay",            "name_ja": "ウルグアイ",   "flag": "🇺🇾"},
    # 欧洲
    "Austria":                 {"code": "AUT", "slug": "austria",            "name_ja": "オーストリア", "flag": "🇦🇹"},
    "Belgium":                 {"code": "BEL", "slug": "belgium",            "name_ja": "ベルギー",     "flag": "🇧🇪"},
    "Bosnia and Herzegovina":  {"code": "BIH", "slug": "bosnia-and-herzegovina", "name_ja": "ボスニア・ヘルツェゴビナ", "flag": "🇧🇦"},
    "Croatia":                 {"code": "CRO", "slug": "croatia",            "name_ja": "クロアチア",   "flag": "🇭🇷"},
    "Czech Republic":          {"code": "CZE", "slug": "czech-republic",     "name_ja": "チェコ",       "flag": "🇨🇿"},
    "England":                 {"code": "ENG", "slug": "england",            "name_ja": "イングランド", "flag": "🏴󠁧󠁢󠁥󠁮󠁧󠁿"},
    "France":                  {"code": "FRA", "slug": "france",             "name_ja": "フランス",     "flag": "🇫🇷"},
    "Germany":                 {"code": "GER", "slug": "germany",            "name_ja": "ドイツ",       "flag": "🇩🇪"},
    "Netherlands":             {"code": "NED", "slug": "netherlands",        "name_ja": "オランダ",     "flag": "🇳🇱"},
    "Norway":                  {"code": "NOR", "slug": "norway",             "name_ja": "ノルウェー",   "flag": "🇳🇴"},
    "Portugal":                {"code": "POR", "slug": "portugal",           "name_ja": "ポルトガル",   "flag": "🇵🇹"},
    "Scotland":                {"code": "SCO", "slug": "scotland",           "name_ja": "スコットランド", "flag": "🏴󠁧󠁢󠁳󠁣󠁴󠁿"},
    "Spain":                   {"code": "ESP", "slug": "spain",              "name_ja": "スペイン",     "flag": "🇪🇸"},
    "Sweden":                  {"code": "SWE", "slug": "sweden",             "name_ja": "スウェーデン", "flag": "🇸🇪"},
    "Switzerland":             {"code": "SUI", "slug": "switzerland",        "name_ja": "スイス",       "flag": "🇨🇭"},
    "Turkey":                  {"code": "TUR", "slug": "turkey",             "name_ja": "トルコ",       "flag": "🇹🇷"},
    # 非洲
    "Algeria":                 {"code": "ALG", "slug": "algeria",            "name_ja": "アルジェリア", "flag": "🇩🇿"},
    "Cape Verde":              {"code": "CPV", "slug": "cape-verde",         "name_ja": "カーボベルデ", "flag": "🇨🇻"},
    "DR Congo":                {"code": "COD", "slug": "dr-congo",           "name_ja": "コンゴ民主共和国", "flag": "🇨🇩"},
    "Egypt":                   {"code": "EGY", "slug": "egypt",              "name_ja": "エジプト",     "flag": "🇪🇬"},
    "Ghana":                   {"code": "GHA", "slug": "ghana",              "name_ja": "ガーナ",       "flag": "🇬🇭"},
    "Ivory Coast":             {"code": "CIV", "slug": "ivory-coast",        "name_ja": "コートジボワール", "flag": "🇨🇮"},
    "Morocco":                 {"code": "MAR", "slug": "morocco",            "name_ja": "モロッコ",     "flag": "🇲🇦"},
    "Senegal":                 {"code": "SEN", "slug": "senegal",            "name_ja": "セネガル",     "flag": "🇸🇳"},
    "South Africa":            {"code": "RSA", "slug": "south-africa",       "name_ja": "南アフリカ",   "flag": "🇿🇦"},
    "Tunisia":                 {"code": "TUN", "slug": "tunisia",            "name_ja": "チュニジア",   "flag": "🇹🇳"},
    # 亚洲 + 大洋洲
    "Australia":               {"code": "AUS", "slug": "australia",          "name_ja": "オーストラリア", "flag": "🇦🇺"},
    "Iran":                    {"code": "IRN", "slug": "iran",               "name_ja": "イラン",       "flag": "🇮🇷"},
    "Iraq":                    {"code": "IRQ", "slug": "iraq",               "name_ja": "イラク",       "flag": "🇮🇶"},
    "Japan":                   {"code": "JPN", "slug": "japan",              "name_ja": "日本",         "flag": "🇯🇵"},
    "Jordan":                  {"code": "JOR", "slug": "jordan",             "name_ja": "ヨルダン",     "flag": "🇯🇴"},
    "New Zealand":             {"code": "NZL", "slug": "new-zealand",        "name_ja": "ニュージーランド", "flag": "🇳🇿"},
    "Qatar":                   {"code": "QAT", "slug": "qatar",              "name_ja": "カタール",     "flag": "🇶🇦"},
    "Saudi Arabia":            {"code": "KSA", "slug": "saudi-arabia",       "name_ja": "サウジアラビア", "flag": "🇸🇦"},
    "South Korea":             {"code": "KOR", "slug": "south-korea",        "name_ja": "韓国",         "flag": "🇰🇷"},
    "Uzbekistan":              {"code": "UZB", "slug": "uzbekistan",         "name_ja": "ウズベキスタン", "flag": "🇺🇿"},
}
